...
public final class BarcodeGenerator implements Comparable<BarcodeGenerator>, Serializable {
     ...
     * @return the new id
     */
    public static BarcodeGenerator get() {
     ...
     * @param date the date
     */
    public BarcodeGenerator(final Date date) {
     ...
     */
    public BarcodeGenerator(final Date date, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of counter is not zero
     */
    public BarcodeGenerator(final int timestamp, final int counter) {
        this(timestamp, counter, true);
    }

    private BarcodeGenerator(final int timestamp, final int counter, final boolean checkCounter) {
        this(timestamp, RANDOM_VALUE1, RANDOM_VALUE2, counter, checkCounter);
    }

    private BarcodeGenerator(final int timestamp, final int randomValue1, final short randomValue2, final int counter,
    ...
    public boolean equals(final Object o) {
        ...
        BarcodeGenerator objectId = (BarcodeGenerator) o;
    ...
    @Override
    public int compareTo(final BarcodeGenerator other) {
        if (other == null) {
